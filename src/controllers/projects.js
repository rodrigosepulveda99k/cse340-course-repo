...
export async function showProjectDetailsPage(req, res) {
    try {
        ...
        if (req.session && req.session.user) {
            // Verificamos si el ID del usuario existe en la sesión
        ...
        // LOG DE DEPURACIÓN: Mira tu consola cuando cargues la página
        console.log(`Proyecto: ${projectId}, Usuario logueado: ${!!req.session.user}, Es voluntario: ${isVolunteering}`);
